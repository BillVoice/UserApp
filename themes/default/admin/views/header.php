            ...
            <div class="container">
                ...
                <div class="header-nav">
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        ?>
                        <li class="dropdown hidden-sm">
                            <a class="btn blightOrange tip" title="<?= lang('alerts') ?>" data-placement="left"
                                data-toggle="dropdown" href="#">
                                <i class="fa fa-exclamation-triangle"></i>
                                <span
                                    class="number bred black"><?= $qty_alert_num + (($Settings->product_expiry) ? $exp_alert_num : 0) + $shop_sale_alerts + $shop_payment_alerts; ?></span>
                            </a>
                            <ul class="dropdown-menu pull-right">
                        ...
                        <li class="dropdown">
                            <a class="btn bdarkGreen tip" id="today_profit"
                                title="<span><?= lang('today_profit') ?></span>" data-placement="bottom"
                                data-html="true" href="<?= admin_url('reports/profit') ?>" data-toggle="modal"
                                data-target="#myModal">
                                    ...
                                    <ul class="nav main-menu">
                                            ...
                                            <ul>
                                                ...
                                                <li id="site_logs_index">
                                                    <a href="<?= admin_url('site_logs') ?>">
                                                        <i class="fa fa-file-text"></i><span class="text">
                                                            <?= lang('site_logs'); ?></span>
                                                    </a>
                                                </li>
                                        ...
                                        <li
                                            ...
                                            <ul>
                                                ...
                                                <li id="sales_deliveries">
                                                    <a class="submenu" href="<?= admin_url('sales/deliveries'); ?>">
                                                        <i class="fa fa-truck"></i><span class="text">
                                        ...
                                        <li class="mm_quotes">
                                            ...
                                            <ul>
                                                <li id="sales_index">
                                                    <a class="submenu" href="<?= admin_url('quotes'); ?>">
                                                        <i class="fa fa-heart-o"></i><span class="text">
